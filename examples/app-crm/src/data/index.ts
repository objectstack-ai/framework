...
const campaigns = defineDataset(Campaign, {
  ...
  records: [
    ...
    },
    {
      ...
      channel: 'digital',
      status: 'completed',
      start_date: new Date(Date.now() - 86400000 * 90),
      end_date: new Date(Date.now() - 86400000 * 30),
      budgeted_cost: 15000,
      actual_cost: 14200,
    ...
    },
    {
      ...
      channel: 'events',
      status: 'planning',
      start_date: new Date(Date.now() + 86400000 * 60),
      end_date: new Date(Date.now() + 86400000 * 63),
      budgeted_cost: 75000,
    ...
    },
    {
      ...
      end_date: new Date(Date.now() + 86400000 * 120),
      budgeted_cost: 50000,
  ...
  records: [
    {
      ...
      signed_date: new Date(Date.now() - 86400000 * 32),
    ...
    },
    {
      ...
      start_date: new Date(Date.now() + 86400000 * 14),
      end_date: new Date(Date.now() + 86400000 * (14 + 365 * 3)),
    ...
    },
    {
      ...
      status: 'expired',
      contract_term_months: 12,
      start_date: new Date(Date.now() - 86400000 * 400),
      ...
      signed_date: new Date(Date.now() - 86400000 * 405),
    ...
    },
    {
      ...
      start_date: new Date(Date.now() + 86400000 * 30),
      end_date: new Date(Date.now() + 86400000 * (30 + 365 * 2)),
  ...
  records: [
    {
      ...
      opportunity: 'Acme Platform Upgrade',
      status: 'accepted',
      quote_date: new Date(Date.now() - 86400000 * 45),
      expiration_date: new Date(Date.now() - 86400000 * 15),
      subtotal: 150000,
      discount: 10,
    ...
    },
    {
      ...
      status: 'presented',
      quote_date: new Date(Date.now() - 86400000 * 7),
      expiration_date: new Date(Date.now() + 86400000 * 23),
      subtotal: 500000,
      discount: 5,
    ...
    },
    {
      ...
      opportunity: 'Wayne Enterprise License',
      status: 'in_review',
      quote_date: new Date(Date.now() - 86400000 * 3),
      expiration_date: new Date(Date.now() + 86400000 * 27),
      subtotal: 1200000,
      discount: 15,
    ...
    },
    {
      ...
      status: 'draft',
      quote_date: new Date(Date.now() - 86400000),
      expiration_date: new Date(Date.now() + 86400000 * 29),
      subtotal: 80000,
      discount: 0,
      discount_amount: 0,
      tax: 6400,
    ...
    },
    {
      ...
      contact: 'emily.d@starkmed.example.com',
      status: 'rejected',
      quote_date: new Date(Date.now() - 86400000 * 60),
