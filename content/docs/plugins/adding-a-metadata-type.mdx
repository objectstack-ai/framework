...
- [Object & Field design](/docs/data-modeling) — the canonical example of a writable metadata type
- [Plugin lifecycle](/docs/plugins/development) — how third-party packages contribute types
