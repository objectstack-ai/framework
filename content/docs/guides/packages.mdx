...
**Approvals Plugin** — Approval-process engine driven by `sys_approval_process` / `sys_approval_request` metadata.

- **Features**: Multi-step approval chains, recall, escalation, audit trail
- **When to use**: Any workflow that needs human sign-off (expense, quote, contract, …)
