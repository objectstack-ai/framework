...
Error `code` values are lowercase snake_case (`validation_error`, `permission_denied`, `rate_limit_exceeded`, `resource_not_found`) — see the [Error Catalog](/docs/guides/cheatsheets/error-catalog) for the full list.
</Callout>
