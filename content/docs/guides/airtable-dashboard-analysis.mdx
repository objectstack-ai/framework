...
|:--------:|:-----|:--------|:-------|:------|
| 🔴 P0 | Add `colorVariant`, `actionUrl`, `description` to `DashboardWidgetSchema` | `spec` | 0.5d | [#713](https://github.com/objectstack-ai/spec/issues/713) |
| 🔴 P0 | Enhance `globalFilters` with `options`, `optionsFrom`, `defaultValue`, `scope`, `targetWidgets` | `spec` | 0.5d | [#712](https://github.com/objectstack-ai/spec/issues/712) |
| 🔴 P0 | Add `header` configuration to `DashboardSchema` | `spec` | 0.5d | [#714](https://github.com/objectstack-ai/spec/issues/714) |
| 🔴 P0 | Add `pivotConfig` and `measures` to `DashboardWidgetSchema` | `spec` | 0.5d | [#714](https://github.com/objectstack-ai/spec/issues/714) |
| 🔴 P0 | Implement `DashboardFilterBar` component | `plugin-dashboard` | 3d | [objectui#588](https://github.com/objectstack-ai/objectui/issues/588) |
| 🔴 P0 | Add color variants + action button to `MetricCard` | `plugin-dashboard` | 1d | [objectui#587](https://github.com/objectstack-ai/objectui/issues/587) |
| 🔴 P0 | Add description + action button to widget headers | `plugin-dashboard` | 1d | [objectui#586](https://github.com/objectstack-ai/objectui/issues/586) |
...
| Priority | Task | Package | Effort | Issue |
|:--------:|:-----|:--------|:-------|:------|
| 🔴 P0 | Implement `PivotTable` component | `plugin-report` | 5d | [objectui#585](https://github.com/objectstack-ai/objectui/issues/585) |
| 🟡 P1 | Implement `funnel` chart type | `plugin-charts` | 1d | [#713](https://github.com/objectstack-ai/spec/issues/713) |
| 🟡 P1 | Implement `grouped-bar` chart type | `plugin-charts` | 1d | [#713](https://github.com/objectstack-ai/spec/issues/713) |
| 🟡 P1 | Implement `stacked-bar` chart type | `plugin-charts` | 1d | [#713](https://github.com/objectstack-ai/spec/issues/713) |
| 🟡 P1 | Implement `horizontal-bar` chart type | `plugin-charts` | 0.5d | [#713](https://github.com/objectstack-ai/spec/issues/713) |
...
| Priority | Task | Package | Effort | Issue |
|:--------:|:-----|:--------|:-------|:------|
| 🟡 P1 | Implement `DashboardHeader` composite component | `plugin-dashboard` | 1d | [objectui#586](https://github.com/objectstack-ai/objectui/issues/586) |
| 🟢 P2 | Implement `gauge` chart type | `plugin-charts` | 2d | [#713](https://github.com/objectstack-ai/spec/issues/713) |
...
- [#712](https://github.com/objectstack-ai/spec/issues/712) — DashboardSchema.globalFilters 协议支持动态选项与数据绑定高级配置
- [#713](https://github.com/objectstack-ai/spec/issues/713) — DashboardWidget type 支持 pivot/funnel/grouped-bar等类型（协议+objectui实现协同）
- [#714](https://github.com/objectstack-ai/spec/issues/714) — Spec: DashboardSchema 支持自定义 header 和 multi-measure 分析配置

**ObjectUI Repository (objectstack-ai/objectui):**
- [#585](https://github.com/objectstack-ai/objectui/issues/585) — PivotTable 组件（交叉矩阵/透视表）支持
- [#586](https://github.com/objectstack-ai/objectui/issues/586) — 新增支持 widget header 描述与操作按钮
- [#587](https://github.com/objectstack-ai/objectui/issues/587) — MetricCard KPI 卡支持彩色变体和操作按钮
- [#588](https://github.com/objectstack-ai/objectui/issues/588) — DashboardFilterBar 组件：实现全局筛选条渲染协议
...
- [Airtable Interfaces Documentation](https://support.airtable.com/docs/creating-interfaces) — Official Airtable interface builder guide
- [React Grid Layout](https://github.com/react-grid-layout/react-grid-layout) — Dashboard grid layout library
- [Recharts Documentation](https://recharts.org/) — Chart visualization library
