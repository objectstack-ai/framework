...
| **type** | `string` | ✅ |  |
| **when** | `string \| Object` | ✅ | Predicate (CEL). e.g. P`record.type == 'enterprise'` |
...
| **message** | `string` | ✅ | Error message to display to the user |
| **type** | `string` | ✅ |  |
| **condition** | `string \| Object` | ✅ | Predicate (CEL) comparing fields. e.g. P`record.end_date > record.start_date` |
...
| **message** | `string` | ✅ | Error message to display to the user |
| **type** | `string` | ✅ |  |
| **condition** | `string \| Object` | ✅ | Predicate (CEL). If TRUE, validation fails. e.g. P`record.amount < 0` |
