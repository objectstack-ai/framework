...
| Property | Type | Required | Description |
| :--- | :--- | :--- | :--- |
| **titleTemplate** | `string \| Object` | optional | PR title template — supports `{{var}`} interpolation |
| **bodyTemplate** | `string \| Object` | optional | PR body template — supports `{{var}`} interpolation |
