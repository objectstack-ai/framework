...
validation. Each entry is a canonical [ActionDescriptorSchema](ActionDescriptorSchema).
...
| Property | Type | Required | Description |
| :--- | :--- | :--- | :--- |
| **actions** | `Object[]` | ✅ | Registered action descriptors (built-in + plugin) |
...
| **data** | `Object` | ✅ | View definition to create |
...
| **view** | `Object` | ✅ | Created view definition |
...
| **entries** | `Object[]` | optional | Enriched per-type registry entries (Phase 3a) |
...
| :--- | :--- | :--- | :--- |
| **object** | `string` | ✅ | Object name |
| **workflows** | `Object[]` | ✅ | Active state-machine workflows for this object |
...
| :--- | :--- | :--- | :--- |
| **object** | `string` | ✅ | Object name |
| **views** | `Object[]` | ✅ | Array of view definitions |
...
| **object** | `string` | ✅ | Object name (snake_case) |
| **viewId** | `string` | ✅ | View identifier |
| **data** | `Object` | ✅ | Partial view data to update |
