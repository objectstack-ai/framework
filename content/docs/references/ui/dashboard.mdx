...
| **layout** | `Object` | optional | Grid layout position (auto-flowed when omitted) |
| **options** | `any` | optional | Widget specific configuration |
| **filterBindings** | `Record<string, string \| boolean>` | optional | Per-widget dashboard-filter bindings: filter name → this widget's field, or false to opt out |
