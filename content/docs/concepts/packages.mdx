...
**Description:** Approval-process engine driven by `sys_approval_process` / `sys_approval_request` metadata.

**Key Features:** Multi-step approval chains, recall, escalation, audit trail, per-step assignees and conditions.
