...
- Permission sets: [`default-permission-sets.ts`](https://github.com/objectstack-ai/objectstack/blob/main/packages/plugins/plugin-security/src/objects/default-permission-sets.ts) — `member_default` / `viewer_readonly` vs `organization_admin` / `admin_full_access`.
- Apps: [`examples/app-showcase/src/ui/apps`](https://github.com/objectstack-ai/objectstack/tree/main/examples/app-showcase/src/ui/apps).
